...
function getConvertMatrix(vertices) {
  const originalTriangle = [
    parseFloat(vertices[0].$.X.value), parseFloat(vertices[0].$.Y.value),
    parseFloat(vertices[1].$.X.value), parseFloat(vertices[1].$.Y.value),
    parseFloat(vertices[2].$.X.value), parseFloat(vertices[2].$.Y.value)];

  const targetTriangle = [
    parseFloat(vertices[0].$.Longitude.value), parseFloat(vertices[0].$.Latitude.value),
    parseFloat(vertices[1].$.Longitude.value), parseFloat(vertices[1].$.Latitude.value),
    parseFloat(vertices[2].$.Longitude.value), parseFloat(vertices[2].$.Latitude.value)];
